...
-Making sure anyone and any device can easily access your web page.
...
-variable is a place holder for a specific value or type of value

4. What is the purpose of using functions in code?
-To define a particular set of commands as one command and save time.
